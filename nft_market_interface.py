...
#토큰 id에 해당하는 토큰을 amount만큼 전송하는 함수
def TokenTransfer(client, sender_address, receiver_address, amount, sender_pk, token_id) :
...
#nft 관련 configuration을 변경한다. 이 경우 escrow (임치 스마스컨트랙트 주소)를 clawback으로 설정한다. clawback은 자산을 이전할 권한이 있다.
...
def buy_nft(client,
    ...
    asa_get_from_buyer_txn_signed = asa_get_from_buyer_txn.sign(buyer_pk)
...
# curl -d "dev_address=FM2ITBJFYMINMCPRQLPGUUCLQOLEEZ2BHTE6CP2AEMKF7QTJOI5GIPM4KU&dev_pk=IfyM4vCYgYa23Vk/wixySpQXcx4aqsij%2BOa6ZWX40UErNImFJcMQ1gnxgt5qUEuDlkJnQTzJ4T9AIxRfwmlyOg==&nft_owner_address=4Q7QX52TW7TJARQGYYWV2RDRGL7LEUK34WXQECKDCLBTCLGNBEDXAAJ2YY&nft_owner_pk=01Lo297AbcmD8zv0Nh%2BLV0YadUdRE59fZxATtdUI/JPkPwv3U7fmkEYGxi1dRHEy/rJRW%2BWvAglDEsMxLM0JBw==&token=212ba0a5ae0335a1443d52dd0af48b51305f621d02a58a267a9dd4985347b90d&ip_address=http://127.0.0.1:43615&unit_name=piece&asset_name=piece&nft_url=https://gateway.pinata.cloud/ipfs/QmZBiFNgb6hWj4JYwXc3PL5QqsoHYaGd4dNv2RWZZzSbjY" -H "Content-Type: application/x-www-form-urlencoded" -X POST http://127.0.0.1:5000/create_nft
...
# curl -d "dev_address=FM2ITBJFYMINMCPRQLPGUUCLQOLEEZ2BHTE6CP2AEMKF7QTJOI5GIPM4KU&dev_pk=IfyM4vCYgYa23Vk/wixySpQXcx4aqsij%2BOa6ZWX40UErNImFJcMQ1gnxgt5qUEuDlkJnQTzJ4T9AIxRfwmlyOg==&nft_owner_address=4Q7QX52TW7TJARQGYYWV2RDRGL7LEUK34WXQECKDCLBTCLGNBEDXAAJ2YY&nft_id=321&token_id=147&sell_price=100&token=212ba0a5ae0335a1443d52dd0af48b51305f621d02a58a267a9dd4985347b90d&ip_address=http://127.0.0.1:43615" -H "Content-Type: application/x-www-form-urlencoded" -X POST http://127.0.0.1:5000/sell_nft
...
# curl -d "nft_owner_address=4Q7QX52TW7TJARQGYYWV2RDRGL7LEUK34WXQECKDCLBTCLGNBEDXAAJ2YY&nft_owner_pk=01Lo297AbcmD8zv0Nh%2BLV0YadUdRE59fZxATtdUI/JPkPwv3U7fmkEYGxi1dRHEy/rJRW%2BWvAglDEsMxLM0JBw==&dev_address=6LB7WPUK3ZBX73F4YEM5TBUCHLLRCVBB5KGZQZE6CKKNVPR7A6S5RRD3FE&dev_pk=6VO1Nync%2Br5k5TQXSX3Ncbcgcoxwob0XqLaF7Hi3fMjyw/s%2Bit5Df%2By8wRnZhoI61xFUIeqNmGSeEpTavj8HpQ==&buyer_address=V6RTLD2D6I6N25LLSLMCRHFZDFSGBQPO3G6L57W6O3GZFGHSBSCBTKTTNU&buyer_pk=Hq2N4DPpa8M%2BdaaoOCrmdfSsbUNvmIAxDbpIxbxQyFqvozWPQ/I83XVrktgonLkZZGDB7tm8vv7eds2SmPIMhA==&nft_id=267&app_id=298&buy_price=100&token_id=147&token=212ba0a5ae0335a1443d52dd0af48b51305f621d02a58a267a9dd4985347b90d&ip_address=http://127.0.0.1:43615" -H "Content-Type: application/x-www-form-urlencoded" -X POST http://127.0.0.1:5000/buy_nft
...
# curl -d "dev_address=FM2ITBJFYMINMCPRQLPGUUCLQOLEEZ2BHTE6CP2AEMKF7QTJOI5GIPM4KU&dev_pk=IfyM4vCYgYa23Vk/wixySpQXcx4aqsij%2BOa6ZWX40UErNImFJcMQ1gnxgt5qUEuDlkJnQTzJ4T9AIxRfwmlyOg==&nft_owner_address=4Q7QX52TW7TJARQGYYWV2RDRGL7LEUK34WXQECKDCLBTCLGNBEDXAAJ2YY&nft_id=267&app_id=290&token_id=147&sell_price=100&token=212ba0a5ae0335a1443d52dd0af48b51305f621d02a58a267a9dd4985347b90d&ip_address=http://127.0.0.1:43615" -H "Content-Type: application/x-www-form-urlencoded" -X POST http://127.0.0.1:5000/stop_sell
...
#curl -d "receiver_pk=IfyM4vCYgYa23Vk/wixySpQXcx4aqsij%2BOa6ZWX40UErNImFJcMQ1gnxgt5qUEuDlkJnQTzJ4T9AIxRfwmlyOg==&token_id=147&token=212ba0a5ae0335a1443d52dd0af48b51305f621d02a58a267a9dd4985347b90d&ip_address=http://127.0.0.1:43615" -H "Content-Type: application/x-www-form-urlencoded" -X POST http://127.0.0.1:5000/token_optin
...
#curl -d "sender_address=FD3NQJQ4S6NDIGNTJ2C2LSCKZHC2PDPGSURBIUPTQWYBK64V7FQPUSUNXU&sender_pk=01Lo297AbcmD8zv0Nh%2BLV0YadUdRE59fZxATtdUI/JPkPwv3U7fmkEYGxi1dRHEy/rJRW%2BWvAglDEsMxLM0JBw==&receiver_address=6LB7WPUK3ZBX73F4YEM5TBUCHLLRCVBB5KGZQZE6CKKNVPR7A6S5RRD3FE&token_id=147&amount=100&token=212ba0a5ae0335a1443d52dd0af48b51305f621d02a58a267a9dd4985347b90d&ip_address=http://127.0.0.1:33755" -H "Content-Type: application/x-www-form-urlencoded" -X POST http://127.0.0.1:5000/token_transfer
...
def token_transfer():
   ...
   client = algod.AlgodClient(token, address, headers=purestake_token)
   sender_pk=sender_pk.replace(" ", "+")
   txn_id = TokenTransfer(client, sender_address, receiver_address, int(amount), sender_pk, int(token_id))
   return jsonify(result='success', txn_id=txn_id)
